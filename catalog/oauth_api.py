...
def gconnect():
    ...
    try:
        ...
        return utils.json_response('Failed to upgrade the '
    ...
    answer = requests.get(userinfo_url, headers={'Authorization': 'Bearer ' +
                          access_token})
    ...
    if user is None:
        user = models.insert_user(login_session['email'],
...
def gdisconnect():
	...
	result = requests.get('https://accounts.google.com/o/oauth2/'
