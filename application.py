...
parser.add_argument('-s', '--setup', help='Set up the database for this web'
                    ' app', action="store_true")
parser.add_argument('-t', '--test', help='Add some test'
                    'data', action="store_true")
parser.add_argument('-c', '--clean', help='Delete cache files & all the'
                    ' stored images', action="store_true")
parser.parse_args()
